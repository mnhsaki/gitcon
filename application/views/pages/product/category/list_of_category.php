                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5" >
                                <div id="" class="dataTables_filter"><label>Search:<input type="search" class="form-control input-sm"
                                                                                          placeholder="Category Name/ID" aria-controls="example1"></label></div>
                            </div>
                            <div class="col-xs-1">
                                <a href="add_new_category"><button type="submit" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp;&nbsp;Category</button></a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th style="width: 290px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-label="Category Name: activate to sort column ascending">Category Name</th>
                                            <th style="width: 190px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-label="Catrgory ID: activate to sort column ascending">Catrgory ID</th>
                                            <th style="width: 290px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-label="Catrgory Note: activate to sort column ascending">Catrgory Note</th>
                                            <th style="width: 110px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-label="Catrgory Image: activate to sort column ascending">Catrgory Image</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($rows as $row):
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td><a href="#" onclick="" data-toggle="modal" data-target=""><?php echo $row['product_category_name']; ?></a></td>
                                                <td><?php echo $row['product_category_id']; ?></td>
                                                <td><?php echo $row['product_category_note']; ?></td>
