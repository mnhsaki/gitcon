                                ...
                                <table id="" class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td><a href="#" onclick="" data-toggle="modal" data-target=""><?php echo $row['zone_id'];?></a></td>
                                            <td><a href="#" onclick="" data-toggle="modal" data-target=""><?php echo $row['division_name'];?></a></a></td>
                                            <td>
