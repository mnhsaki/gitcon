                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <ul class="pagination pagination-sm no-margin pull-right">
                            <a href="<?php echo site_url('add_new_suppliers'); ?>"><i class="fa fa-plus-circle"></i></a>
                        </ul>
                    </div>
                </div>
                <!-- /.box-header -->
...
<!--                                            <th style="width: 44px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                            ...
                                            <th style="width: 136px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                                aria-label="Name: activate to sort column ascending">Name</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 113px;"
                                                aria-label="Email: activate to sort column ascending">Email</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 125px;"
                                                aria-label="Phone Number: activate to sort column ascending">Phone Number</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" style="width: 71px;"
                                                aria-label="Address: activate to sort column ascending">Address</th>
                                            <th style="width: 93px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <!--<td>Warehouse</td>-->
                                            <td><a href="#"><?php echo $row['supplier_name']; ?></a></td>
                                            <td><?php echo $row['supplier_email']; ?></td>
                                            <td><?php echo $row['supplier_phone_number']; ?></td>
                                            <td>
                                                <p><?php echo $row['supplier_address']; ?></p>
                                            </td>
                                            <td><a href="#" class="btn btn-primary btn-xs">Edit</a>
                                                <a href="#" onclick="return checkadd();" class="btn btn-danger btn-xs">Delete</a></td>
                                        </tr>
                                        <?php endforeach; ?>     
